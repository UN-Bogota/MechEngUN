...
def ic_fun(rpm,m_diesel,rv):
    ...
    epsilon = rv#14.58  # compression ratio [-]
    ...
    injector_open = 250. / 180. * np.pi
    injector_close = 265. / 180. * np.pi
    injector_mass = m_diesel # kg
...
# xticks = np.arange(0.0, sim_n_revolutions/f, 0.02)
